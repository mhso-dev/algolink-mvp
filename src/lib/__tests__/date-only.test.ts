...
test("date-only: KST start/end ISO boundaries preserve date-only intent", () => {
  ...
  assert.equal(dateOnlyToKstEndIso("2026-05-01"), "2026-05-01T15:00:00.000Z");
...
test("date-only: project range stores inclusive same-day as half-open KST all-day range", () => {
  assert.deepEqual(normalizeDateOnlyRangeForProject("2026-05-01", "2026-05-01"), {
    education_start_at: "2026-04-30T15:00:00.000Z",
    education_end_at: "2026-05-01T15:00:00.000Z",
  });
});
